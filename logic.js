...
const preguntasPorEmpresa = {
  ...
  'guaicaramo': {
    ...
    datosCuriosos_es: [
      ...
      "🏆 Empresa líder: Guaicaramo es una empresa líder reconocida en Colombia en el sector de la palma, cítricos y ganadería. Actualmente, cuenta con certificaciones que respaldan su modelo de producción.",
      "🏥 Impacto social: Desde el 2023, Guaicaramo en alianza con la Fundación Manos Pintadas de Azul y la Patrulla Aérea Colombiana, ha liderado 4 brigadas de salud impactando a más de 1789 personas.",
    ...
    datosCuriosos_en: [
      ...
      "🏆 Leading company: Guaicaramo is a leading company recognized in Colombia in the palm, citrus and livestock sector. Currently, it has certifications that support its production model.",
      "🏥 Social impact: Since 2023, Guaicaramo in alliance with the Fundación Manos Pintadas de Azul and the Colombian Air Force, has led 4 health brigades impacting more than 1789 people.",
